App.registerModule('usuarios', {
    ...
    async showForm(id) {
        ...
        document.getElementById('uModalBody').innerHTML = ''
            ...
            + '<input id="fUNombre" type="text" autocomplete="off" value="' + user.nombre + '" style="width:100%;padding:10px 12px;border:1px solid #e2e8f0;border-radius:8px;font-size:13px;outline:none;transition:border-color 0.2s" onfocus="this.style.borderColor=\'#3b82f6\'" onblur="this.style.borderColor=\'#e2e8f0\'"></div>'
            ...
            + '<input id="fUEmail" type="email" autocomplete="off" value="' + user.email + '" style="width:100%;padding:10px 12px;border:1px solid #e2e8f0;border-radius:8px;font-size:13px;outline:none;transition:border-color 0.2s" onfocus="this.style.borderColor=\'#3b82f6\'" onblur="this.style.borderColor=\'#e2e8f0\'"></div>'
            ...
            + '<input id="fUPassword" type="password" autocomplete="new-password" ' + (id ? '' : 'required') + ' style="width:100%;padding:10px 12px;border:1px solid #e2e8f0;border-radius:8px;font-size:13px;outline:none;transition:border-color 0.2s" onfocus="this.style.borderColor=\'#3b82f6\'" onblur="this.style.borderColor=\'#e2e8f0\'"></div>'
