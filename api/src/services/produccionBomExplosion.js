...
const explosionBOM = async (r, recetaBomMap, materiaPrimaMap, materiasPrimas, familia, estacionesFinales, m2, resultados, mecanizadoOperaciones) => {
...
const crearOrdenSimple = async (r, familia, estacionesFinales, m2, resultados, mecanizadoOperaciones) => {
    const costo_hh = familia ? Number(familia.costo_hh) : 0;
    const costo_energia = familia ? Number(familia.costo_energia) : 0;
