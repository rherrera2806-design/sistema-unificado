                    ...
                    <div class="m-card" style="margin-bottom:10px">
                        ...
                        <div class="m-card-body" style="padding:8px 12px">
                            ${this._allMovimientos.length === 0
                                ...
                                : `<div class="m-table-wrap"><table><thead><tr><th>Fecha</th><th>Tipo</th><th>Codigo</th><th>Cristal</th><th>Espesor</th><th>Dimensiones</th><th>Cantidad</th><th>m2</th><th>Proveedor</th><th>Turno</th></tr></thead><tbody>${this.renderRows(this._allMovimientos.slice(0, 20))}</tbody></table></div>`
                            }
                        </div>
                    </div>
                </div>`;
