    ...
    async renderHistory(maquinaId) {
        ...
        return `
            ...
            <div class="stats-grid">
                <div class="stat-card dash-card hist-card" style="border-left:4px solid #3b82f6"><div class="stat-icon blue"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-2px"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg></div><div class="stat-info"><p class="stat-label">Mantenciones</p><p class="stat-sub">Preventivas</p></div><div class="stat-value">${preventivos.length}</div></div>
                <div class="stat-card dash-card hist-card" style="border-left:4px solid #ef4444"><div class="stat-icon red"><svg width="14" height="14" viewBox="0 0 24 24" fill="#ef4444" style="vertical-align:-2px"><circle cx="12" cy="12" r="6"/></svg></div><div class="stat-info"><p class="stat-label">Fallas</p><p class="stat-sub">Correctivas</p></div><div class="stat-value">${correctivos.length}</div></div>
                <div class="stat-card dash-card hist-card" style="border-left:4px solid #f59e0b"><div class="stat-icon orange"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-2px"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><div class="stat-info"><p class="stat-label">Horas detención</p><p class="stat-sub">Acumuladas</p></div><div class="stat-value">${totalHorasDet}</div></div>
                <div class="stat-card dash-card hist-card" style="border-left:4px solid #22c55e"><div class="stat-icon green"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-2px"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></div><div class="stat-info"><p class="stat-label">Componentes</p><p class="stat-sub">Registrados</p></div><div class="stat-value">${componentes.length}</div></div>
            </div>
            <div class="card hist-card">
