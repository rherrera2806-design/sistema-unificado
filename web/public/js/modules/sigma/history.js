App.registerModule('history', {
    ...
    async render() {
        ...
        el.innerHTML = `
            ...
            <div style="position:relative;z-index:1"><h2 style="margin:0;font-size:14px;font-weight:800;color:white;letter-spacing:-0.5px">Historial por Maquina</h2>
            <p style="margin:2px 0 0;font-size:9px;color:rgba(255,255,255,0.7)">Ficha completa de intervenciones</p></div></div>
            <style>
