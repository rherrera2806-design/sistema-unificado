    ...
    async render() {
        ...
        el.innerHTML = `
            ...
            <div style="display:flex;gap:6px;align-items:center">
                <div style="background:rgba(255,255,255,0.15);border:1px solid rgba(255,255,255,0.2);border-radius:6px;padding:3px 8px;text-align:center"><div style="font-size:8px;color:rgba(255,255,255,0.7);text-transform:uppercase;font-weight:600">Tipos</div><div style="font-size:15px;font-weight:800;color:white;line-height:1.2">${tiposCount}</div></div>
                <div style="background:rgba(255,255,255,0.15);border:1px solid rgba(255,255,255,0.2);border-radius:6px;padding:3px 8px;text-align:center"><div style="font-size:8px;color:rgba(255,255,255,0.7);text-transform:uppercase;font-weight:600">Maquinas</div><div style="font-size:15px;font-weight:800;color:white;line-height:1.2">${maqsCount}</div></div>
