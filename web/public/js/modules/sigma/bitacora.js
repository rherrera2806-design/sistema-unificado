...
<div style="position:relative;z-index:1"><h2 style="margin:0;font-size:24px;font-weight:800;color:white;letter-spacing:-0.5px">Bitácora de Mantención</h2>
<p style="margin:6px 0 0;font-size:13px;color:rgba(255,255,255,0.7)">Historial completo de mantenciones realizadas</p></div></div>
            <style>
