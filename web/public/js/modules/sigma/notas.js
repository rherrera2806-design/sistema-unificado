App.registerModule('notas', {
    ...
    async render() {
        ...
        el.innerHTML = `
            ...
            <div style="position:relative;z-index:1;display:flex;justify-content:space-between;align-items:center;gap:16px;flex-wrap:wrap"><div><h2 style="margin:0;font-size:18px;font-weight:800;color:white;letter-spacing:-0.5px">Notas</h2>
            <p style="margin:2px 0 0;font-size:11px;color:rgba(255,255,255,0.7)">Comunicación entre turnos</p></div>
