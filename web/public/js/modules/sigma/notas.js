        ...
        el.innerHTML = `
            ...
            <p style="margin:6px 0 0;font-size:13px;color:rgba(255,255,255,0.7)">Comunicación entre turnos</p></div>
                <div style="display:flex;align-items:center;gap:12px">
                    <div style="position:relative"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.5)" stroke-width="2" style="position:absolute;left:12px;top:50%;transform:translateY(-50%)"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg><input type="text" id="notaSearch" placeholder="Buscar por autor, contenido o fecha..." oninput="App.modules.notas.filtrar()" style="width:280px;padding:10px 14px 10px 36px;border:1px solid rgba(255,255,255,0.2);border-radius:10px;font-size:13px;color:white;background:rgba(255,255,255,0.1);backdrop-filter:blur(8px);outline:none;transition:all 0.2s" onfocus="this.style.borderColor='rgba(255,255,255,0.5)';this.style.background='rgba(255,255,255,0.15)'" onblur="this.style.borderColor='rgba(255,255,255,0.2)';this.style.background='rgba(255,255,255,0.1)'"></div>
