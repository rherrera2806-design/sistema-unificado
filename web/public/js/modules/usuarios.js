App.registerModule('usuarios', {
    async render() {
        ...
        el.innerHTML = '<style>'
            ...
            + '#uSearch::placeholder{color:rgba(255,255,255,0.6)}'
            + '</style>'
