App.registerModule('turnos', {
            ...
            if (pl) pl.innerHTML = p.length === 0 ? '<div style="text-align:center;color:#94a3b8;padding:20px;font-size:13px">No hay entregas pendientes</div>' : p.map(e => {
                ...
                return `<div style="padding:14px 20px;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;gap:8px;transition:background 0.1s" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='white'">
                    ...
                    <div style="display:flex;gap:6px;align-items:center">
                        ${Number(e.adjuntos_count) > 0 ? `<button onclick="App.modules.turnos.verAdjuntos(${e.turno_id})" class="btn btn-sm" style="color:#7c3aed;background:#f3e8ff;border:1px solid #e9d5ff"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-1px"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg> PDF (${e.adjuntos_count})</button>` : ''}
    ...
    async showAlmacen() {
        ...
        c.innerHTML = '<style>'
            ...
            + '<button onclick="App.modules.turnos.addTecnicoAlm()" title="Agregar encargado" class="btn btn-primary"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-2px"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg> Agregar</button></div>'
