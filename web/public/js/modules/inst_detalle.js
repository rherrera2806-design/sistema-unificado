App.registerModule('inst_detalle', {
    ...
    renderDetalle() {
        ...
        el.innerHTML = '<style>'
            ...
            + '<div><h2 style="margin:0;font-size:18px;font-weight:800;color:white;letter-spacing:-0.5px">Instalacion #' + inst.id + '</h2>'
            + '<p style="margin:4px 0 0;font-size:11px;color:rgba(255,255,255,0.7)">' + escapeHtml(inst.cliente) + ' &middot; ' + escapeHtml(inst.direccion || '') + '</p></div>'
            + '</div>'
