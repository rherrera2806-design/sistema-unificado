App.registerModule('inst_historial', {
    ...
    async render() {
        ...
        el.innerHTML = '<style>'
            ...
            + '<div style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 50%,#1e40af 100%);border-radius:16px;padding:20px 32px;margin-bottom:24px;position:relative;overflow:hidden;box-shadow:0 4px 20px rgba(15,23,42,0.3)">'
            ...
            + '<p style="margin:4px 0 0;font-size:12px;color:rgba(255,255,255,0.7)">Listado completo de todas las instalaciones</p></div>'
