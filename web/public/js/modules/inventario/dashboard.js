...
<div style="position:relative;z-index:1"><h2 style="margin:0;font-size:15px;font-weight:800;color:white;letter-spacing:-0.5px">Dashboard Inventario</h2>
<p style="margin:2px 0 0;font-size:10px;color:rgba(255,255,255,0.7)">Acciones Rapidas</p></div></div>
                <style>
