...
<div style="position:relative;z-index:1"><h2 style="margin:0;font-size:18px;font-weight:800;color:white;letter-spacing:-0.5px">Historial</h2>
<p style="margin:4px 0 0;font-size:11px;color:rgba(255,255,255,0.7)">Consultar movimientos de inventario</p></div></div>
                <style>
