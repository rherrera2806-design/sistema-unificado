    ...
    renderContent() {
        ...
        this._currentData.forEach(m => {
            ...
            if (canEdit || canDel) {
                ...
                if (canEdit) acciones += `<button class="btn btn-sm" style="background:#eff6ff;color:#2563eb;border:1px solid #bfdbfe;margin-right:4px" title="Editar" onclick='InvHistorial.editar(${JSON.stringify(m).replace(/'/g,"&#39;")})'>Editar</button>`;
