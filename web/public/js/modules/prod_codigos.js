...
<div style="position:relative;z-index:1;display:flex;justify-content:space-between;align-items:center"><div><h2 style="margin:0;font-size:18px;font-weight:800;color:white;letter-spacing:-0.5px">Codigos de Producto</h2>
<p style="margin:2px 0 0;font-size:11px;color:rgba(255,255,255,0.7)">Catalogo maestro de codigos SAP - Grupo, Familia, Bloque de Tela</p></div>
${puedeEditar ? `
