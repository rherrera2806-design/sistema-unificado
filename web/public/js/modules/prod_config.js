App.registerModule('prod_config', {
    ...
    async render() {
        ...
        const tabs = [
            ...
            { id: 'carroceria', label: 'Carroceros', svg: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20h20"/><path d="M5 20V8l5 4V8l5 4V4h3v16"/></svg>' },
