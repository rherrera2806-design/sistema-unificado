App.registerModule('prod_config', {
    ...
    async render() {
        ...
        el.innerHTML = '<style>'
            ...
            + '<p style="margin:2px 0 0;font-size:11px;color:rgba(255,255,255,0.7)">Estaciones, Codigos, Maquinas, Recetas BOM, Familias, Materias Primas y Calendario</p></div></div>'
                ...
                <div class="card-body" style="padding:0">
                    ...
                    <tbody>${this._reglas.map(r => `<tr>
                        ...
                        <td class="table-actions">
                            ...
                            <button class="btn btn-sm btn-danger" onclick="App.modules.prod_config.deleteRegla(${r.id})"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                        </td>
                    </tr>`).join('')}</tbody></table>
                </div>
            </div>`;
