    ...
    async render() {
        ...
        if (!this._initialized || !document.getElementById('ast-content')) {
            ...
            el.innerHTML = '<style>'
                ...
                + '.ranking-container{display:flex;gap:10px;justify-content:center;align-items:stretch;padding:12px 0;flex-wrap:wrap}'
                + '.ranking-card{border-radius:12px;padding:12px 14px 10px;text-align:center;flex:1 1 0;min-width:80px;box-shadow:0 2px 12px rgba(0,0,0,0.06)}'
