    ...
    renderReporte(reporte) {
        ...
        tbody.innerHTML = reporte.map((r, i) => {
            ...
            return '<tr style="border-bottom:1px solid #f1f5f9">'
                ...
                + '<td style="padding:12px 16px"><span style="font-weight:600;color:' + (permisos > 0 ? '#0891b2' : '#475569') + '">' + permisos + '</span></td>'
                + '<td style="padding:12px 16px"><span style="font-weight:600;color:' + (licencias > 0 ? '#d97706' : '#475569') + '">' + licencias + ' días</span></td>'
                + '<td style="padding:12px 16px"><span style="font-weight:600;color:' + (vacaciones > 0 ? '#2563eb' : '#475569') + '">' + vacaciones + ' días</span></td>'
